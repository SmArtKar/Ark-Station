...
/mob/living/carbon/human/New(var/new_loc, var/new_species = null)
	...
	hud_list[STATUS_HUD]      = new /image/hud_overlay('code_ark/icons/huds.dmi', src, "hudhealthy")
	hud_list[LIFE_HUD]	      = new /image/hud_overlay('code_ark/icons/huds.dmi', src, "hudhealthy")
	...
	hud_list[STATUS_HUD_OOC]  = new /image/hud_overlay('code_ark/icons/huds.dmi', src, "hudhealthy")
