...
/mob/living/silicon/robot/Initialize()
	...
	hud_list[STATUS_HUD]      = new /image/hud_overlay('code_ark/icons/huds.dmi', src, "hudhealth100")
	hud_list[LIFE_HUD]        = new /image/hud_overlay('code_ark/icons/huds.dmi', src, "hudhealth100")
